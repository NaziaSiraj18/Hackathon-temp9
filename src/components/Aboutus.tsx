    ...
    <section className="bg-black px-4 md:px-12 lg:px-24 flex flex-col justify-evenly md:flex-row md:items-center py-12 md:py-20">
      ...
      <div className="mt-12 md:mt-0 flex flex-col items-center md:items-start">
        ...
        <Image
          ...
          height={400}
        />
        <div className="flex flex-col md:flex-row md:gap-4 mt-8 md:mt-4">
          <Image
            src="/about2.jpeg"
            alt="About Us Image 2"
            className="object-cover rounded-lg w-full md:w-[200px] lg:w-[250px]"
            width={200}
            height={200}
          />
          <Image
            ...
            className="object-cover rounded-lg w-full md:w-[200px] lg:w-[250px] mt-4 md:mt-0"
            width={200}
            height={200}
          />
        </div>
